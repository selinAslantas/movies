...
class TopRateMovieDetailPage extends StatefulWidget {
  final Movie topRateMovie;


  const TopRateMovieDetailPage({Key key, this.topRateMovie}) : super(key: key);

  @override
  _TopRateMovieDetailPageState createState() => _TopRateMovieDetailPageState();
}

class _TopRateMovieDetailPageState extends State<TopRateMovieDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          "${widget.topRateMovie.title ?? "Undıfıned"}",
        ),
      ),
      body: Container(
        ...
        child: ListView(
          children: [
            Column(
              children: <Widget>[
                Hero(
                  tag: "${widget.topRateMovie.backdropPath}",
                  child: Image.network(
                      "https://image.tmdb.org/t/p/w500${widget.topRateMovie.backdropPath}"),
                ),
              ],
            ),
            Column(
              children: <Widget>[
                Row(
                  children: <Widget>[
                    ...
                    Text(
                      "${widget.topRateMovie.voteAverage}",
            ...
            Container(
              ...
              child: Text(
                "${widget.topRateMovie.releaseDate}",
                style: TextStyle(
                    color: Colors.white,
                    fontSize: 18,
            ...
            FutureBuilder(
                future: getCast(
                  ...
                  movieId: widget.topRateMovie.id,
                ),
                builder:
