...
class UpcomingMovieDetailPage extends StatefulWidget {
  final Movie upcomingMovie;


  const UpcomingMovieDetailPage({Key key, this.upcomingMovie}) : super(key: key);

  @override
  _UpcomingMovieDetailPageState createState() => _UpcomingMovieDetailPageState();
}

class _UpcomingMovieDetailPageState extends State<UpcomingMovieDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          "${widget.upcomingMovie.title ?? "Undıfıned"}",
        ),
      ),
      body: Container(
        ...
        child: ListView(
          children: [
            Column(
              children: <Widget>[
                Hero(
                  tag: "${widget.upcomingMovie.backdropPath}",
                  child: Image.network(
                      "https://image.tmdb.org/t/p/w500${widget.upcomingMovie.backdropPath}"),
                ),
              ],
            ),
            Column(
              children: <Widget>[
                Row(
                  children: <Widget>[
                    ...
                    Text(
                      "${widget.upcomingMovie.voteAverage}",
            ...
            Container(
              ...
              child: Text(
                "${widget.upcomingMovie.releaseDate}",
                style: TextStyle(
                    color: Colors.white,
                    fontSize: 18,
            ...
            FutureBuilder(
                future: getCast(
                  ...
                  movieId: widget.upcomingMovie.id,
                ),
                builder:
